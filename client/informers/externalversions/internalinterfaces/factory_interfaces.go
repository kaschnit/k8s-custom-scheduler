...
// NewInformerFunc takes scheduling.Interface and time.Duration to return a SharedIndexInformer.
type NewInformerFunc func(scheduling.Interface, time.Duration) cache.SharedIndexInformer
