...
func (in *PreemptedByRule) DeepCopyInto(out *PreemptedByRule) {
	*out = *in
	if in.FromQueues != nil {
		in, out := &in.FromQueues, &out.FromQueues
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PreemptedByRule.
func (in *PreemptedByRule) DeepCopy() *PreemptedByRule {
	if in == nil {
		return nil
	}
	out := new(PreemptedByRule)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PreemptsRule) DeepCopyInto(out *PreemptsRule) {
	*out = *in
	if in.FromPods != nil {
		in, out := &in.FromPods, &out.FromPods
		*out = new(metav1.LabelSelector)
	...
	if in.ToQueues != nil {
		in, out := &in.ToQueues, &out.ToQueues
		*out = new(metav1.LabelSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.ToPods != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PreemptsRule.
func (in *PreemptsRule) DeepCopy() *PreemptsRule {
	if in == nil {
		return nil
	}
	out := new(PreemptsRule)
	in.DeepCopyInto(out)
	return out
}
